...
const GridProduct = ({ product }) => {
    return (
        // <Link to={`/product/${product.id}`} className='border p-4 flex flex-col items-center justify-between rounded-md bg-slate-100 hover:shadow-sm'>
        <div key={product.id} className='border p-4 flex flex-col items-center justify-between rounded-md bg-slate-100 hover:shadow-sm'>
