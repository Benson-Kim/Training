        ...
        <div className='flex-col w-max px-6 pt-3 pb-6 rounded-sm'>
            ...
            <article>
                <div className='hidden uppercase text-slate-500 md:grid grid-cols-8 gap-10 text-sm font-semibold py-2'>
                    ...
                    <div className='flex flex-col md:grid grid-cols-8 my-3 mx-1'>
                        <article className='flex col-span-3' >
                            ...
                            <div className='flex flex-col '>
                                <h2 className='pl-[10px]'>Product title</h2>
                                <h3 className='text-slate-400 pl-[10px] capitalize text-sm'>product category</h3>    
                            </div>
                        </article>
                        ...
                        <h2 className='text-slate-700 font-semibold text-sm mt-[25px] text-center ml-4'>$22.55</h2>
                        <h2 className='text-slate-700 font-semibold text-sm mt-[25px] text-center ml-4'>$59.00</h2>
                        <button
